...
@Size(max=1024)   public String getCorrespondenceAddress() {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, plumberInfo.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, licenseNo, mobileNumber, gender, fatherOrHusbandName, correspondenceAddress, relationship, additionalDetails);
  }
