...
public class WsQueryBuilder {
	...
	private final static String WATER_SEARCH_Query = "SELECT wc.connectionCategory, wc.rainWaterHarvesting, wc.connectionType, wc.waterSource, wc.meterId, "
			+ "wc.meterInstallationDate, wc.pipeSize, wc.noOfTaps, wc.uom, wc.waterSubSource, wc.calculationAttribute, wc.connection_id as connection_Id, conn.applicationNo, conn.applicationStatus, conn.status, conn.connectionNo, conn.connectionExecutionDate,"
