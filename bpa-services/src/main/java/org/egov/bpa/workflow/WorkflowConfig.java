...
/*    private  void setRoleActionMap(){
    ...
    private  void setActionCurrentStatusMap(){
        ...
        map.put(STATUS_PAID, Arrays.asList(ACTION_DOC_VERIFICATION_FORWARD, ACTION_FORWORD,ACTION_SENDBACK,ACTION_MARK));
        map.put(STATUS_DOCUMENTVERIFICATION, Arrays.asList(ACTION_FIELDINSPECTION_FORWARD, ACTION_FORWORD,ACTION_SENDBACK,ACTION_MARK));
