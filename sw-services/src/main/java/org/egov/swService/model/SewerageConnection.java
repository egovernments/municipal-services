...
public class SewerageConnection extends Connection {
	...
	private Long noOfWaterClosets = null;

	@JsonProperty("noOfToilets")
	private Long noOfToilets = null;
	...
	public SewerageConnection noOfWaterClosets(Long noOfWaterClosets) {
	...
	public Long getNoOfWaterClosets() {
		return noOfWaterClosets;
	}

	public void setNoOfWaterClosets(Long noOfWaterClosets) {
		this.noOfWaterClosets = noOfWaterClosets;
	}

	public SewerageConnection noOfToilets(Long noOfToilets) {
	...
	public Long getNoOfToilets() {
		return noOfToilets;
	}

	public void setNoOfToilets(Long noOfToilets) {
		this.noOfToilets = noOfToilets;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(connectionExecutionDate, noOfWaterClosets, noOfToilets, uom, calculationAttribute,
				connectionType, super.hashCode());
	}
