...
import org.egov.rb.contract.Address;
import org.egov.rb.model.user.Citizen;
...
public class Service   {
  ...
  private String tenantId="pb.testing";

  @NotNull
  @JsonProperty("serviceCode")
  @Size(min=2,max=50)
  @Pattern(regexp="^[a-zA-Z0-9._]*$")
  private String serviceCode="GarbageNeedsTobeCleared";
