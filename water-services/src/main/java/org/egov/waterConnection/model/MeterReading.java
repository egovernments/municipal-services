...
public class MeterReading {
	 ...
	 * @return id
	 **/
	@ApiModelProperty(readOnly = true, value = "Unique Identifier of the meter reading for internal reference.")
	 ...
	 **/
	@ApiModelProperty(readOnly = true, value = "Formatted billingPeriod")
	 ...
	 * @return lastReading
	 **/
	@ApiModelProperty(value = "Last Reading")
	 ...
	 **/
	@ApiModelProperty(value = "The date of meter last reading date.")
	 ...
	 **/
	@ApiModelProperty(value = "Current Reading")
	 ...
	 **/
	@ApiModelProperty(value = "The date of meter current reading date.")
	 ...
	 * @return consumption
	 **/
	@ApiModelProperty(value = "Meter Reading Consumption")
