package org.egov.echallan.expense.repository.builder;
...
public class ExpenseQueryBuilder {
    ...
    @Autowired
    public ExpenseQueryBuilder(ChallanConfiguration config) {
        this.config = config;
    }
    ...
    public String getExpenseSearchQuery(SearchCriteria criteria, List<Object> preparedStmtList) {
