...
import org.egov.echallan.expense.web.models.Idgen.IdGenerationRequest;
import org.egov.echallan.expense.web.models.Idgen.IdGenerationResponse;
import org.egov.echallan.expense.web.models.Idgen.IdRequest;
...
@Repository
public class IdGenExpenseRepository {
    ...
    @Autowired
    public IdGenExpenseRepository(RestTemplate restTemplate, ChallanConfiguration config) {
