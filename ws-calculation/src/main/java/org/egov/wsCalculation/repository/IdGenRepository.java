...
public class IdGenRepository {
    ...
    @Autowired
    public IdGenRepository(RestTemplate restTemplate, WSCalculationConfiguration wSCalculationConfiguration) {
        this.restTemplate = restTemplate;
        this.wSCalculationConfiguration = wSCalculationConfiguration;
    }
    ...
    public IdGenerationResponse getId(RequestInfo requestInfo, String tenantId, String name, String format, int count) {
        ...
        try {
            response = restTemplate.postForObject( wSCalculationConfiguration.getIdGenHost()+ wSCalculationConfiguration.getIdGenPath(), req, IdGenerationResponse.class);
