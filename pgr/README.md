...
- Please refer to the [Swagger API contarct](https://raw.githubusercontent.com/egovernments/municipal-services/master/pgr/src/main/resources/swagger-contract.yml#!/) for PGR to understand the structure of APIs and to have visualization of all internal APIs.
