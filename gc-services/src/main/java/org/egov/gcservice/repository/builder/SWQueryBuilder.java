package org.egov.gcservice.repository.builder;
...
import org.egov.gcservice.service.UserService;
...
import static org.egov.gcservice.util.GCConstants.SEARCH_TYPE_CONNECTION;
...
public class SWQueryBuilder {
	...
	public String getSearchQueryString(SearchCriteria criteria, List<Object> preparedStatement,
		...
		if (!StringUtils.isEmpty(criteria.getMobileNumber()) || !StringUtils.isEmpty(criteria.getPropertyId())) {
			List<Property> propertyList = garbageServicesUtil.propertySearchOnCriteria(criteria, requestInfo);
