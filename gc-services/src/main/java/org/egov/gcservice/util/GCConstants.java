...
public class GCConstants {
	...
	public static final String INVALID_CONNECTION_TYPE = "Invalid GarbageConnection Type";
	...
	public static final String DEFAULT_OBJECT_EDIT_SMS_MSG = "Dear <Owner Name>, Your Application <Application number>  for a New <Service> GarbageConnection has been edited. For more details, please log in to <mseva URL> or download <mseva app link>.";

	public static final String DEFAULT_OBJECT_EDIT_APP_MSG = "Dear <Owner Name>, Your Application <Application number>  for a New <Service> GarbageConnection has been edited. Click here for more details <View History Link>.";
	...
	public static final String DEFAULT_OBJECT_MODIFY_SMS_MSG = "Dear <Owner Name>, Your Application <Application number>  for a New <Service> GarbageConnection has been edited. For more details, please log in to <mseva URL> or download <mseva app link>.";

	public static final String DEFAULT_OBJECT_MODIFY_APP_MSG = "Dear <Owner Name>, Your Application <Application number>  for a New <Service> GarbageConnection has been edited. Click here for more details <View History Link>.";
