...
import org.egov.gcservice.web.models.workflow.BusinessServiceResponse;
...
public class WorkflowService {
	...
	@Autowired
	public WorkflowService(GCConfiguration config, ServiceRequestRepository serviceRequestRepository,
			ObjectMapper mapper) {
		this.config = config;
	...
	/**
	    ...
	    */
		 ...
		 * @param tenantId
		 */
		public void validateInProgressWF(List<GarbageConnection> GarbageConnectionList, RequestInfo requestInfo,
										 String tenantId) {
			Set<String> applicationNos = GarbageConnectionList.stream().map(GarbageConnection::getApplicationNo).collect(Collectors.toSet());
