...
public class UserService {
	...
	private Set<String> getMobileNumbers(GarbageConnectionRequest garbageConnectionRequest) {
		Set<String> listOfMobileNumbers = garbageConnectionRequest.getGarbageConnection().getConnectionHolders()
	 ...
	 * @param requestInfo          RequestInfo from the GarbageConnectionRequest
	...
	public void updateUser(GarbageConnectionRequest request, GarbageConnection existingGarbageConnection) {
		if (!CollectionUtils.isEmpty(existingGarbageConnection.getConnectionHolders())) {
