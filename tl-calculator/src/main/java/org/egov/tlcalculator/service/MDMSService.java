...
public class MDMSService {
    ...
    private MdmsCriteriaReq getMDMSRequest(RequestInfo requestInfo, String tenantId) {
        ...
        fyMasterDetails.add(
                MasterDetail.builder().name(TLCalculatorConstants.MDMS_FINANCIALYEAR).filter(filterCodeForUom).build());
        ...
        taxPeriodMasterDetails
                .add(MasterDetail.builder().name(TLCalculatorConstants.MDMS_TAXPERIOD).filter(serviceCode).build());
    ...
    public Map getCalculationType(RequestInfo requestInfo, TradeLicense license, Object mdmsData) {
        ...
        try {
            ...
            String jsonPath = TLCalculatorConstants.MDMS_CALCULATIONTYPE_FINANCIALYEAR_PATH.replace("{}",
                    maxClosestYear);
    ...
    private Map defaultMap() {
        ...
        defaultMap.put(TLCalculatorConstants.MDMS_CALCULATIONTYPE_TRADETYPE,
                config.getDefaultTradeUnitCalculationType());
        defaultMap.put(TLCalculatorConstants.MDMS_CALCULATIONTYPE_ACCESSORY,
                config.getDefaultAccessoryCalculationType());
        return defaultMap;
    }
